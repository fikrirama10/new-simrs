...
/**
 * PenerimaanBarangDetailSearch represents the model behind the search form of `common\models\PenerimaanBarangDetail`.
 */
class PenerimaanBarangDetailSearch extends PenerimaanBarangDetail
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'idpenerimaan', 'idbarang', 'idbacth'], 'integer'],
    ...
    {
        $query = PenerimaanBarangDetail::find()->joinWith(['obat as obat'])->orderBy(['obat.nama_obat'=>SORT_ASC]);
