...
/**
 * PermintaanObatdetailSearch represents the model behind the search form of `common\models\PermintaanObatdetail`.
 */
class PermintaanObatdetailSearch extends PermintaanObatdetail
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'idpermintaan', 'idobat'], 'integer'],
    ...
    {
        $query = PermintaanObatdetail::find();
        ...
        $query->andFilterWhere([
            ...
            'idobat' => $this->idobat,
            'jumlah_setuju' => $this->jumlah_setuju,
            'harga' => $this->harga,
            'total' => $this->total,
