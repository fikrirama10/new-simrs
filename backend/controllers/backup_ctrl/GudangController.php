...
class GudangController extends Controller
{
	...
	public function actionMasukStok($id){
		...
		foreach($penerimaan as $pr){
			...
			Yii::$app->kazo->kartuStok($pr->idbarang,$pr->idbacth,1,$pr->jumlah_diterima,2);	
			Yii::$app->kazo->mutasiStok($pr->idbarang,$pr->idbacth,2,2,$pr->jumlah_diterima,$pr->id,$obat_bacth->stok_gudang,1);
