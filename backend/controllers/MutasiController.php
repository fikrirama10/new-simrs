...
class MutasiController extends Controller
{
	...
	public function actionShowObat($start,$end,$idgudang){
		$url = Yii::$app->params['baseUrl'].'dashboard/rest-inventori/obat?start='.$start.'&end='.$end.'&idgudang='.$idgudang;
	...
	public function actionPrint($start,$end,$idgudang){
		$url = Yii::$app->params['baseUrl'].'dashboard/rest-inventori/obat?start='.$start.'&end='.$end.'&idgudang='.$idgudang;
		$content = file_get_contents($url);
		$json = json_decode($content, true);
