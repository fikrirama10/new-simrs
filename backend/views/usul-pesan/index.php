...
<div class='box box-body'>
		<h2><?= $this->title ?></h2><hr>
			<?= GridView::widget([
				...
				'type'=>'success',
				'before'=>Html::a('<i class="fas fa-plus"></i> Permintaan Obat', ['create'], ['class' => 'btn bg-primary']),
				...
				'columns' => [
					...
					[
						...
						'value' => function ($model, $key, $index, $widget) { 
								return $model->permintaan->status;
						},
					...
					[
						...
						'filterInputOptions' => ['placeholder' => 'Jenis UP'], // allows multiple authors to be chosen
						'format' => 'raw'
					],
