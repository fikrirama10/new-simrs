...
$urlPenunjang = Yii::$app->params['baseUrl'].'dashboard/rest/tarif-penunjang';
		...
		<div class='box'>
			...
			<div class="nav-tabs-custom">
				<ul class="nav nav-tabs">
					<li  class="active" class=""><a href="#tab_usia" data-toggle="tab" aria-expanded="false"> Tindakan Medis</a></li>
					<li class=""><a href="#tab_agama" data-toggle="tab" aria-expanded="false"> Tindakan Penunjang</a></li>
				</ul>
					...
					<div class="tab-pane active" id="tab_usia">
						<?php $form = ActiveForm::begin(); ?>
							...
							<?= $form->field($soaptindakan, 'idtindakan')->widget(Select2::classname(), [
								...
								'options' => ['placeholder' => 'Tindakan Medis .....'],
								'pluginOptions' => [
								'allowClear' => true,
							...
							<select class='form-control' id='jenis-bayar' name='bayar2' required>
							...
							<select class='form-control' id='dokter-bayar' name='dokter2' required>
				...
				<!-- /.tab-pane -->
					<div class="tab-pane" id="tab_agama">
						<?php $form = ActiveForm::begin(); ?>
							<?= $form->field($tarif_trx, 'idrawat')->hiddeninput(['maxlength' => true,'value'=>$model->id])->label(false) ?>
							<?= $form->field($tarif_trx, 'idbayar')->hiddeninput(['maxlength' => true,'value'=>$model->idbayar])->label(false) ?>
							<?= $form->field($tarif_trx, 'idtarif')->widget(Select2::classname(), [
								'name' => 'kv-repo-template',
								'options' => ['placeholder' => 'Penunjang .....'],
								'pluginOptions' => [
								'allowClear' => true,
								'minimumInputLength' => 3,
								'ajax' => [
					...
					<h5>Tindakan Dokter</h5>
						<table class='table table-bordered'>
							...
							<tr>
								...
								<td><?= $t->bayar->bayar ?></td>
								<td><a href='<?= Url::to(['poliklinik/hapus-tindakan?id='.$t->id]) ?>' class='btn btn-danger btn-xs'>Hapus</a></td>
							</tr>
							<?php } ?>
						</table>
