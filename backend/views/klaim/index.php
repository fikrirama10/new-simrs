...
<div class='row'>
	<div class='col-md-12'>
		<div class='box box-header'><h3>BPJS</h3></div>
		<div class='box box-body'>
			<div class="alert alert-warning alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                <h4><i class="icon fa fa-barcode"></i> Masukan Rekam medis Pasien </h4>
                Silahkan scan dengan scaner barcode atau ketik Rekam medis Pasien.
              </div>
...
<div class='col-md-12'>
	<div class='box box-body'>
		<?= GridView::widget([
				'panel' => ['type' => 'default', 'heading' => 'BPJS'],
						...
						'buttons' => [
								...
								'view' => function ($url,$model) {
										...
										return Html::a(
												...
												Url::to(['kunjungan?id='.$model->kunjungans->id]));
...
<?php 
$urlShowAll = Url::to(['laboratorium/show']);
$this->registerJs("
