...
?>
<div class='box'>
<div class='box-header with-border'><h4>Statistik Pasien Radiologi</h4></div>
<div class='box-body'>
	<div class='row'>
		<div class='col-md-6'>
			<table class='table'>
		...
		<div class='col-md-12'>
			<div class="nav-tabs-custom">
				<ul class="nav nav-tabs">
					<li  class="active" class=""><a href="#tab_usia" data-toggle="tab" aria-expanded="false"> Radiologi</a></li>
					<li class=""><a href="#tab_agama" data-toggle="tab" aria-expanded="false"> Pelayanan</a></li>
					<li class=""><a href="#tab_etnis" data-toggle="tab" aria-expanded="false">Tindakan</a></li>
				</ul>
				<div class="tab-content">
					<div class="tab-pane active" id="tab_usia">
						<?= $this->render('_dataRadiologi',[
							'model' => $model,
						]) ?>
					</div>
				<!-- /.tab-pane -->
...
$urlShowAll = Url::to(['radiologi-order/show-kunjungan']);
$this->registerJs("	
