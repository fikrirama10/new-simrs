...
<?php $form = ActiveForm::begin(); ?>
	...
	<?= $form->field($tambahSoap, 'idbayar')->hiddeninput(['maxlength' => true,'value'=>$model->idbayar])->label(false) ?>
	<?= $form->field($tambahSoap, 'iddokter')->hiddeninput(['maxlength' => true,'value'=>$model->iddokter])->label(false) ?>
	<?= $form->field($tambahSoap, 'klinis')->textinput(['maxlength' => true,])?>
	<?= $form->field($tambahSoap, 'tgl_permintaan')->hiddeninput(['maxlength' => true,'value'=>date('Y-m-d H:i:s',strtotime('+6 hour',strtotime(date('Y-m-d H:i:s'))))])->label(false) ?>
	...
	<?= $form->field($tambahSoap, 'idtindakan')->widget(Select2::classname(), [
