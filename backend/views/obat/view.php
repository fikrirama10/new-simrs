	  ...
	  <div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<div class="row">
				<div class="col-md-4">
					<?= $form->field($obat, 'no_bacth')->textInput(['maxlength' => true,'required'=>true]) ?>
				</div>
				<div class="col-md-8">
					<?= $form->field($obat, 'merk')->textInput(['maxlength' => true,'required'=>true]) ?>
				</div>
				<div class="col-md-4">
					<?= $form->field($obat, 'stok_gudang')->textInput(['maxlength' => true,'required'=>true]) ?>
					
				</div>
				<div class="col-md-4">
					<?= $form->field($obat, 'idsuplier')->dropDownList(ArrayHelper::map(ObatSuplier::find()->all(), 'id', 'suplier'),['prompt'=>'- Suplier -','required'=>true])->label('Suplier')?>
				</div>
				<div class="col-md-4">
					<?= $form->field($obat, 'kat_obat')->dropDownList(ArrayHelper::map(ObatKategori::find()->all(), 'id', 'kategori'),['prompt'=>'- Kategori Obat -','required'=>true])->label('Kategori Obat')?>
				</div>
			
				<div class="col-md-4">
					<?= $form->field($obat, 'harga_beli')->textInput(['maxlength' => true,'required'=>true]) ?>
				</div>
				<div class="col-md-6">
					<?=	$form->field($obat, 'tgl_produksi')->widget(DatePicker::classname(),[
				...
				<div class="col-md-6">
					<?=	$form->field($obat, 'tgl_kadaluarsa')->widget(DatePicker::classname(),[
						'type' => DatePicker::TYPE_COMPONENT_APPEND,
						'pluginOptions' => [
						'autoclose'=>true,
						'format' => 'yyyy-mm-dd',
