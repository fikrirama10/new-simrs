				...
				<div class="form-group">
					...
					<div class="col-md-3 col-sm-3 col-xs-12">
						<div class="input-group date">
							<input type="date" class="form-control datepicker" id="txttglrujukan" value='<?=date('Y-m-d',strtotime($sep['response']['tglSep']))?>' max='<?=date('Y-m-d',strtotime($sep['response']['tglSep']))?>' min='<?=date('Y-m-d',strtotime($sep['response']['tglSep']))?>' name='tglrujukan'>
