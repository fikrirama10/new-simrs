...
?>
	<?php $form = ActiveForm::begin(); ?>
		<?= $form->field($fisio_tambah, 'idrawat')->hiddeninput(['maxlength' => true,'value'=>$model->id])->label(false) ?>
		<?= $form->field($fisio_tambah, 'iddokterpeminta')->hiddeninput(['maxlength' => true,'value'=>$model->iddokter])->label(false) ?>
		<?= $form->field($fisio_tambah, 'tgl')->hiddeninput(['maxlength' => true,'value'=>date('Y-m-d H:i:s',strtotime('+6 hour',strtotime(date('Y-m-d H:i:s'))))])->label(false) ?>
		<?= $form->field($fisio_tambah, 'status')->hiddeninput(['maxlength' => true,'value'=>1])->label(false) ?>
		<?= $form->field($fisio_tambah, 'idbayar')->hiddeninput(['maxlength' => true,'value'=>$model->idbayar])->label(false) ?>
		<?= $form->field($fisio_tambah, 'idtindakan')->widget(Select2::classname(), [
