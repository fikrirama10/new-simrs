				...
				<div class='box-body'>
					<div class='row'>
						...
						<div class='col-md-6 col-xs-6'>
							<div class="input-group">
								<input type="text" readonly id="pasien-kodepasien" name="Pasien[kodepasien]" value='<?= $model->kodepasien?>' class="form-control">
					...
					<div class='row'>
						...
						<div class='col-md-8 col-xs-8'>
							<div class="input-group">
								<input type="text" value='<?= $model->no_bpjs?>' id="pasien-no_bpjs" name="Pasien[no_bpjs]" class="form-control">
					...
					<div class='row'>
						...
						<div class='col-md-8 col-xs-8'>
							<input type="text" value='<?= $model->nik?>' id="pasien-nik" name="Pasien[nik]" class="form-control">
						</div>
					</div>
					<div class='row'>
						<div class='col-md-4 col-xs-4 '><span class='pull-right pd-top'>NAMA PASIEN</span></div>
						<div class='col-md-8 col-xs-8'>
							<input type="text" id="pasien-nama_pasien" value='<?= $model->nama_pasien?>' name="Pasien[nama_pasien]" required class="form-control">
						</div>
					</div>
					<div class='row'>
					...
					<div class='row'>
						...
						<div class='col-md-8 col-xs-8'>
							<input type="text" value='<?= $model->tempat_lahir?>' id="pasien-tempat_lahir" name="Pasien[tempat_lahir]" class="form-control">
						</div>
					</div>
					<div class='row'>
					...
					<div class='row'>
						...
						<div class='col-md-8 col-xs-8'>
							<input type="text"value='<?= $model->kepesertaan_bpjs?>' readonly id="pasien-kepesertaan_bpjs" name="Pasien[kepesertaan_bpjs]" class="form-control">
						</div>
					</div>
					<div class='row'>
			...
			<div class='box-header with-border'><h4>INFORMASI TAMBAHAN</h4></div>
				<div class='box-body'>
					...
					<div class='row'>
						...
						<div class='col-md-8 col-xs-8'>
							<?= $form->field($model, 'idetnis')->dropDownList(ArrayHelper::map(DataEtnis::find()->all(), 'id', 'etnis'),['prompt'=>'- Pilih Etnis -'])->label(false)?>
						</div>						
					</div>
					<div class='row'>
