...
<div class="amprah-gudangobat-index">
    ...
    <?= GridView::widget([
				'panel' => ['type' => 'default', 'heading' => 'Barang / ATK'],
				...
				'pjax'=>true,
				'panel' => [
				'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon glyphicon-list-alt"></i> Amprah Barang / ATK</h3>',
				'type'=>'success',
