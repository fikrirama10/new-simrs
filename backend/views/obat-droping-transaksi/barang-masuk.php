...
<div class='row'>		
	<div class='col-md-12'>
		<div class="box">
			<div class="box-header with-border"><h4>Barang Masuk (Obat Droping)</h4></div>
			<div class="box-body">
				<?= DetailView::widget([
					'model' => $model,
					'attributes' => [
		...
		<div class='col-md-12'>
			...
			<div class="box">
				...
				<div id='lanjutan'>
							...
							<div class='col-md-6'>
								...
								<div class="input-group" id='manual'>
									<span class="input-group-addon">
										...
										<input type="text" id='barang_bacth' class="form-control" name="ObatDropingBatch[no_batch]">
								</div>
								<div id='pilih'>
						...
						<div id='row'>
							<div class='col-md-6'>
								<?=	$form->field($bacth, 'produksi')->widget(DatePicker::classname(),[
							...
							<div class='col-md-6'>
								<?=	$form->field($bacth, 'ed')->widget(DatePicker::classname(),[
									'type' => DatePicker::TYPE_COMPONENT_APPEND,
									'pluginOptions' => [
									'autoclose'=>true,
									'format' => 'yyyy-mm-dd',
		...
		<div class='col-md-12'>
			...
			<?php if($model->status == 1){ ?>
				<a class='btn btn-warning' href='<?= Url::to(['barang-masuk-stok?id='.$model->id])?>'>Tambahkan Ke Stok</a>
			<?php } ?>
		</div>
</div>
<?php
$urlShowAll = Url::to(['obat-droping-transaksi/show-merk']);
$this->registerJs("
