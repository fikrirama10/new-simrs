			...
			<div class='box-body'>
				...
				<div class="form-group">
					...
					<div class="col-md-5 col-sm-5 col-xs-12">
						<div class="input-group">
							<input type="text" class="form-control" id="txtnomr" name='no_mr' value='<?=$data_sep['response']['peserta']['noMr']?>' placeholder="ketik nomor MR" maxlength="10">
							<span class="input-group-addon">
...
$this->registerJs("
	...
	$('#admisi-ranap').hide();
	// $('#provinsi_value').val($('#provinsi').val());
