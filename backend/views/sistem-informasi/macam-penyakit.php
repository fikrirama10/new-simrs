<div class='header'>
	...
	<div class='header2'>
	Lampiran I Laporan Bulanan Kegiatan RSAU Lanud Sulaiman Tanggal <?= date('d F Y',strtotime($end))?>
	</div>
</div>
<div class='header upper'>
	<b>MACAM PENYAKIT / JUMLAH PENDERITA <br>BULAN <?= date('F Y',strtotime($end))?></b>
</div>
<div class='si'>
<table>
		<tr>
