<div class='header'>
	...
	<div class='header2'>
	Lampiran VII Laporan Bulanan Kegiatan RSAU Lanud Sulaiman Tanggal <?= date('d F Y',strtotime($end))?>
	</div>
</div>
<div class='header upper'>
	<b>PENGUNJUNG DAN KUNJUNGAN POLIKLINIK <br>BULAN <?= date('F Y',strtotime($end))?></b>
</div>
<div class='si'> 
