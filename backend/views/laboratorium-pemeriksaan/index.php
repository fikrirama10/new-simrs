...
$this->title = 'Pemeriksaan Laboratorium';
...
<div class='box box-body'>
		<h2><?= $this->title ?></h2><hr>
			<?= GridView::widget([
				...
				'type'=>'success',
				'before'=>Html::a('<i class="fas fa-redo"></i> Tambah Pelayanan', ['create'], ['class' => 'btn bg-info']),
				...
				'columns' => [
					...
					[
						...
						'filter' => ArrayHelper::map(LaboratoriumLayanan::find()->all(), 'id', 'nama_layanan'), 
						'filterWidgetOptions' => [
