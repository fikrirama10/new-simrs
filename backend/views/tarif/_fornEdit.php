	...
	<div class='box box-body'>
		<table class='table table-bordered'>
			...
			<tr>
				...
				<td><?= $form->field($model, 'sewakamar')->textInput() ?></td>
				<td><?= $form->field($model, 'makanpasien')->textInput() ?></td>
				<td><?= $form->field($model, 'nova_t')->textInput() ?></td>
			</tr>
			<tr>
				<td><?= $form->field($model, 'laundry')->textInput() ?></td>		
				<td><?= $form->field($model, 'cs')->textInput() ?></td>
				<td><?= $form->field($model, 'opsrs')->textInput() ?></td>
				<td><?= $form->field($model, 'perekam_medis')->textInput() ?></td>
				<td><?= $form->field($model, 'radiografer')->textInput() ?></td>
			</tr>
			<tr>
				<td><?= $form->field($model, 'radiolog')->textInput() ?></td>		
				<td><?= $form->field($model, 'assisten')->textInput() ?></td>
				<td><?= $form->field($model, 'operator')->textInput() ?></td>
				<td><?= $form->field($model, 'ass_tim')->textInput() ?></td>
				<td><?= $form->field($model, 'dokter_anastesi')->textInput() ?></td>
			</tr>
			<tr>
				<td><?= $form->field($model, 'sewa_ok')->textInput() ?></td>		
				<td><?= $form->field($model, 'asisten_anastesi')->textInput() ?></td>
				<td><?= $form->field($model, 'cssd')->textInput() ?></td>
				<td><?= $form->field($model, 'bbm')->textInput() ?></td>
				<td><?= $form->field($model, 'ranmor')->textInput() ?></td>
			</tr>
			<tr>
				<td><?= $form->field($model, 'supir')->textInput() ?></td>		
				<td><?= $form->field($model, 'dokter')->textInput() ?></td>
				<td><?= $form->field($model, 'rs')->textInput() ?></td>
				<td><?= $form->field($model, 'harbang')->textInput() ?></td>
				<td><?= $form->field($model, 'atlm')->textInput() ?></td>
			</tr>
		</table>
	</div>
