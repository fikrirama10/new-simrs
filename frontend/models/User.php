...
class User extends ActiveRecord 
{
	...
	public static function validationJwt($token){
		...
		$data->setIssuer('http://localhost/new-simrs');
		$data->setAudience('http://localhost/new-simrs');
	...
	public static function generateToken($id){
		...
		$token = $jwt->getBuilder()
			->issuedBy('http://localhost/new-simrs')
			->permittedFor('http://localhost/new-simrs')
